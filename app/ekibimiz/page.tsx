      ...
      <div>
        ...
        <div className="bg-white ">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <br />
            <div className="flex flex-col md:flex-row gap-4 text-green-800 "></div>
            <div className="flex flex-col md:flex-row ">
              <h1 className="text-4xl text-green-950">Avukatlarımız</h1>
            </div>
            <br />
            <p className="text-gray-600 text-sm">
              BÜROMUZ BÜNYESİNDE ÇALIŞAN AVUKATLARIMIZ
            </p>{" "}
          </div>
